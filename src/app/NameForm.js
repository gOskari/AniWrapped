    ...
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <div className="relative">
          ...
          <input type="text" name='route' onChange={(e)=>{setRoute(e.target.value)}} className="block w-full h-12 p-4 pl-10 text-lg text-secondary-color border border-secondary-color rounded-lg bg-primary-color" placeholder="Anilist Username" />
